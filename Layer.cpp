...
Layer::Layer(QQuickItem* parent)
  : QQuickFramebufferObject(parent),
    ...
    m_gamma(1)
{
    connect(this, &Layer::isValidChanged, this, &Layer::onImageChanged);
    connect(this, &Layer::imageChanged, this, &Layer::onImageChanged);
}
...
void Layer::setImage(Image* image)
{
    ...
    if(m_image != nullptr)
    {
        ...
        m_imageSignalConnections.push_front(connect(m_image, &Image::sizeChanged, this, &Layer::imageChanged));
        m_imageSignalConnections.push_front(connect(m_image, &Image::imageTypeChanged, this, &Layer::imageChanged));
        m_imageSignalConnections.push_front(connect(m_image, &Image::channelCountChanged, this, &Layer::imageChanged));
    }
